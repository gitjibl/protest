...
export default {
  ...
  mounted() {
    this.map = new Map({
      ...
      layers: [this.createTdtWMTSLayer()],
      view: new View({
  ...
  methods: {
    createTdtWMTSLayer() {
        ...
        const source = new WMTS({
            // url: 'http://t'+Math.round(Math.random()*7)+'.tianditu.gov.cn/img_c/wmts?tk=1cab703e4cce846ba8c4363be6f0ccd8',
            // url:"http://t0.tianditu.gov.cn/vec_c/wmts?tk=1cab703e4cce846ba8c4363be6f0ccd8",
            url:"http://t0.tianditu.gov.cn/cva_c/wmts?tk=1cab703e4cce846ba8c4363be6f0ccd8",
            // url:"http://t0.tianditu.gov.cn/ibo_c/wmts?tk=1cab703e4cce846ba8c4363be6f0ccd8",         
            // url: 'http://t0.tianditu.gov.cn/img_c/wmts?tk=1cab703e4cce846ba8c4363be6f0ccd8',
            // url: 'http://t0.tianditu.gov.cn/img_w/wmts?tk=1cab703e4cce846ba8c4363be6f0ccd8',
            layer: 'cva',
            style: 'default',
            matrixSet: 'c',
            format: 'tiles',
